...
const VideoConsultation = () => {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-gradient-to-br from-custom-light-blue via-custom-light-teal to-custom-light-cyan rounded-2xl shadow-xl transition-shadow duration-300 hover:shadow-2xl">
      <h2 className="text-4xl font-bold mb-4 text-center text-blue-700 animate-pulse">
        Video Consultation
      </h2>
      <p className="mb-6 text-gray-700 text-center">
        Connect with our healthcare professionals through a virtual
        consultation.
      </p>
      ...
      {isConsulting ? (
        ...
        <div className="flex flex-col items-center">
          ...
          <button
            ...
            onClick={() => {
              /* View consultation history logic */
            }}
          >
