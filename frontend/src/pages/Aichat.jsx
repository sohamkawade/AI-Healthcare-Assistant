...
function Chatbot() {
    ...
    const horizontalQuestions = [
        ...
        { text: "Gum Disease", icon: <FaQuestionCircle className="w-4 h-4 mr-2" /> },
        { text: "Cavity", icon: <FaQuestionCircle className="w-4 h-4 mr-2" /> },
        { text: "Dental Emergency", icon: <FaQuestionCircle className="w-4 h-4 mr-2" /> },
    ...
    const symptomVariations = {
        // Common Symptoms
        "fever": ["fever", "temperature", "hot", "running temperature", "high temperature", "low temperature", "feverish", "febrile", "pyrexia", "hyperthermia"],
        "headache": ["headache", "head pain", "head ache", "migraine", "cephalalgia", "head throbbing", "head pounding", "head pressure", "head tension"],
        "cold": ["cold", "common cold", "nasal congestion", "runny nose", "sneezing", "rhinorrhea", "nasal discharge", "upper respiratory infection"],
        "cough": ["cough", "coughing", "dry cough", "wet cough", "productive cough", "non-productive cough", "hacking cough", "chest congestion"],
        "body pain": ["body pain", "body ache", "muscle pain", "joint pain", "muscle ache", "body soreness", "myalgia", "arthralgia", "body stiffness"],
        "stomach pain": ["stomach pain", "stomach ache", "abdominal pain", "belly pain", "tummy pain", "gastralgia", "abdominal discomfort", "stomach cramps"],
        
        // Dental Symptoms
        "toothache": ["toothache", "tooth pain", "dental pain", "tooth ache", "tooth sensitivity", "tooth discomfort", "dental sensitivity", "tooth throbbing"],
        "gum disease": ["gum disease", "gum problems", "gum infection", "gum bleeding", "gum pain", "gum swelling", "gingivitis", "periodontitis", "gum inflammation"],
        "cavity": ["cavity", "dental cavity", "tooth cavity", "dental caries", "tooth decay", "dental decay", "tooth rot", "dental hole", "tooth damage"],
        "bad breath": ["bad breath", "halitosis", "mouth odor", "dental odor", "oral odor", "breath odor", "foul breath", "unpleasant breath"],
        
        // Respiratory Symptoms
        "asthma": ["asthma", "wheezing", "breathing difficulty", "shortness of breath", "chest tightness", "bronchial asthma", "respiratory distress"],
        "bronchitis": ["bronchitis", "chest congestion", "productive cough", "bronchial infection", "chest infection", "bronchial inflammation"],
        "pneumonia": ["pneumonia", "lung infection", "chest infection", "respiratory infection", "pulmonary infection", "lower respiratory infection"],
        "sinusitis": ["sinusitis", "sinus infection", "sinus pressure", "sinus pain", "nasal congestion", "sinus headache", "rhinosinusitis"],
        "allergies": ["allergies", "allergic reaction", "allergic symptoms", "allergic response", "allergen reaction", "hypersensitivity"],
        
        // Heart & Blood Symptoms
        "high blood pressure": ["high blood pressure", "hypertension", "elevated blood pressure", "blood pressure high", "high bp", "hypertensive"],
        "diabetes": ["diabetes", "high blood sugar", "diabetic", "sugar", "hyperglycemia", "diabetes mellitus", "type 1 diabetes", "type 2 diabetes"],
        "anemia": ["anemia", "low blood", "iron deficiency", "low hemoglobin", "blood deficiency", "low red blood cells", "anemic"],
        "heart disease": ["heart disease", "cardiac disease", "heart condition", "heart problem", "cardiac condition", "heart disorder"],
        "cholesterol": ["cholesterol", "high cholesterol", "lipid disorder", "hyperlipidemia", "high lipids", "elevated cholesterol"],
        
        // Digestive Symptoms
        "acid reflux": ["acid reflux", "heartburn", "gastroesophageal reflux", "gerd", "reflux", "stomach acid", "acid regurgitation"],
        "ibs": ["ibs", "irritable bowel syndrome", "bowel problems", "digestive issues", "intestinal problems", "bowel disorder"],
        "ulcer": ["ulcer", "stomach ulcer", "peptic ulcer", "gastric ulcer", "duodenal ulcer", "ulcer pain", "ulcer symptoms"],
        "liver problems": ["liver problems", "liver disease", "liver condition", "hepatic disease", "liver disorder", "liver dysfunction"],
        "gallbladder": ["gallbladder", "gallbladder problems", "gallbladder disease", "gallbladder pain", "gallbladder attack", "biliary colic"],
        
        // Mental Health Symptoms
        "anxiety": ["anxiety", "anxious", "panic", "worry", "nervousness", "anxiety attack", "panic attack", "anxiety disorder"],
        "depression": ["depression", "depressed", "sadness", "mood disorder", "clinical depression", "major depression", "depressive"],
        "insomnia": ["insomnia", "sleeplessness", "sleep problems", "sleep disorder", "trouble sleeping", "inability to sleep"],
        "stress": ["stress", "stressed", "pressure", "tension", "overwhelmed", "stress symptoms", "stress disorder"],
        "panic attacks": ["panic attack", "panic disorder", "anxiety attack", "panic symptoms", "acute anxiety", "panic episode"],
        
        // Skin Symptoms
        "eczema": ["eczema", "atopic dermatitis", "skin rash", "skin inflammation", "dermatitis", "skin irritation", "itchy skin"],
        "psoriasis": ["psoriasis", "skin condition", "scaly skin", "skin disorder", "psoriatic", "skin inflammation"],
        "acne": ["acne", "pimples", "zits", "skin breakouts", "acne vulgaris", "skin blemishes", "facial acne"],
        "skin cancer": ["skin cancer", "melanoma", "basal cell carcinoma", "squamous cell carcinoma", "skin tumor", "skin lesion"],
        "hair loss": ["hair loss", "alopecia", "balding", "thinning hair", "hair thinning", "hair fall", "hair shedding"],
        
        // Bone & Joint Symptoms
        "arthritis": ["arthritis", "joint pain", "joint inflammation", "rheumatoid arthritis", "osteoarthritis", "joint stiffness"],
        "osteoporosis": ["osteoporosis", "bone loss", "weak bones", "bone thinning", "bone density loss", "fragile bones"],
        "back pain": ["back pain", "lower back pain", "upper back pain", "spinal pain", "backache", "back discomfort"],
        "sciatica": ["sciatica", "sciatic pain", "nerve pain", "leg pain", "back pain", "nerve compression"],
        "sports injury": ["sports injury", "athletic injury", "sports trauma", "sports accident", "athletic trauma"],
        
        // Women's Health Symptoms
        "menstrual issues": ["menstrual issues", "period problems", "menstrual pain", "period pain", "menstrual cramps", "dysmenorrhea"],
        "pregnancy care": ["pregnancy", "pregnant", "prenatal", "maternal health", "pregnancy symptoms", "pregnancy care"],
        "menopause": ["menopause", "menopausal", "hot flashes", "menopause symptoms", "perimenopause", "post-menopause"],
        "breast health": ["breast health", "breast problems", "breast pain", "breast changes", "breast symptoms"],
        "pcos": ["pcos", "polycystic ovary syndrome", "hormonal disorder", "ovarian cysts", "hormone imbalance"],
        
        // Children's Health Symptoms
        "child fever": ["child fever", "baby fever", "pediatric fever", "infant fever", "child temperature", "baby temperature"],
        "child growth": ["child growth", "growth problems", "growth delay", "developmental delay", "child development"],
        "child nutrition": ["child nutrition", "pediatric nutrition", "child diet", "baby nutrition", "child feeding"],
        "child vaccination": ["child vaccination", "baby vaccination", "pediatric vaccination", "immunization", "child shots"],
        "child development": ["child development", "developmental delay", "child milestones", "developmental problems", "child progress"]
    };
    ...
    const predefinedQA = {
        ...
        "hello": "Hello! I'm your AI Healthcare Assistant. I can help you with medical conditions, care instructions, and doctor recommendations. How can I assist you with your health concerns today?",
        ...
        "good morning": "Good morning! I'm your AI Healthcare Assistant. I can help you with medical conditions, care instructions, and doctor recommendations. How can I assist you with your health concerns today?",
        "good afternoon": "Good afternoon! I'm your AI Healthcare Assistant. I can help you with medical conditions, care instructions, and doctor recommendations. How can I assist you with your health concerns today?",
        "good evening": "Good evening! I'm your AI Healthcare Assistant. I can help you with medical conditions, care instructions, and doctor recommendations. How can I assist you with your health concerns today?",
        "good night": "Good night! I'm your AI Healthcare Assistant. I can help you with medical conditions, care instructions, and doctor recommendations. How can I assist you with your health concerns today?",
        "bye": "Take care! If you have any health concerns, feel free to ask. Remember to prioritize your health and well-being. Goodbye!",
        "goodbye": "Take care! If you have any health concerns, feel free to ask. Remember to prioritize your health and well-being. Goodbye!",
        "thanks": "You're welcome! Remember, I'm here to help with any health-related questions or concerns you may have. Take care of your health!",
        "thank you": "You're welcome! Remember, I'm here to help with any health-related questions or concerns you may have. Take care of your health!",
        "please": "I'm here to help with your health concerns. Please feel free to ask any medical questions or seek advice about your well-being.",
        "sorry": "No need to apologize! I'm here to help with your health concerns. Please feel free to ask any medical questions or seek advice about your well-being.",
        "excuse me": "I'm here to help with your health concerns. Please feel free to ask any medical questions or seek advice about your well-being.",
        
        // Common Questions with Health Context
        "what is your name": "I'm your AI Healthcare Assistant, designed to provide medical information and care instructions. How can I help you with your health concerns today?",
        "who are you": "I'm your AI Healthcare Assistant, designed to provide medical information and care instructions. How can I help you with your health concerns today?",
        "what can you do": "I can help you with medical conditions, symptoms, treatments, doctor recommendations, and general health advice. What health concerns would you like to discuss?",
        "how are you": "I'm ready to help you with your health-related questions! What health concerns would you like to discuss?",
        "are you real": "I'm an AI healthcare assistant designed to provide medical information and care instructions. How can I help you with your health concerns today?",
        "are you human": "I'm an AI healthcare assistant designed to provide medical information and care instructions. How can I help you with your health concerns today?",
        "are you a bot": "I'm an AI healthcare assistant designed to provide medical information and care instructions. How can I help you with your health concerns today?",
        "are you ai": "I'm an AI healthcare assistant designed to provide medical information and care instructions. How can I help you with your health concerns today?",
...
Pediatric Dentist for children`
    ...
    const isHealthRelated = (message) => {
        ...
        const healthKeywords = [
            // Symptoms
            'symptom', 'pain', 'fever', 'cough', 'headache', 'ache', 'swelling', 'bleeding',
            'nausea', 'vomiting', 'diarrhea', 'constipation', 'fatigue', 'weakness', 'dizziness',
            'rash', 'itch', 'burning', 'sore', 'stiff', 'numb', 'tingling', 'cramp', 'spasm',
            
            // Body Parts
            'head', 'neck', 'back', 'chest', 'stomach', 'abdomen', 'arm', 'leg', 'hand', 'foot',
            'eye', 'ear', 'nose', 'throat', 'mouth', 'teeth', 'gum', 'tongue', 'lip', 'skin',
            'heart', 'lung', 'liver', 'kidney', 'brain', 'bone', 'joint', 'muscle', 'nerve',
            
            // Conditions
            'disease', 'infection', 'virus', 'bacteria', 'fungus', 'injury', 'wound', 'cut',
            'bruise', 'fracture', 'sprain', 'strain', 'cancer', 'diabetes', 'asthma', 'allergy',
            'ulcer', 'inflammation', 'swelling', 'tumor', 'cyst', 'abscess', 'rash', 'blister',
            
            // Medical Terms
            'medical', 'health', 'doctor', 'hospital', 'clinic', 'medicine', 'treatment', 'therapy',
            'diagnosis', 'prognosis', 'prescription', 'medicine', 'drug', 'vaccine', 'immunization',
            'checkup', 'examination', 'test', 'scan', 'x-ray', 'mri', 'ct', 'ultrasound',
            
            // Health Categories
            'dental', 'mental', 'physical', 'emotional', 'psychological', 'neurological',
            'cardiovascular', 'respiratory', 'digestive', 'endocrine', 'immune', 'reproductive',
            
            // Treatments
            'treatment', 'cure', 'remedy', 'medicine', 'drug', 'therapy', 'surgery', 'operation',
            'procedure', 'rehabilitation', 'recovery', 'healing', 'prevention', 'preventive',
            
            // Lifestyle
            'diet', 'nutrition', 'exercise', 'fitness', 'sleep', 'rest', 'stress', 'anxiety',
            'depression', 'weight', 'obesity', 'hypertension', 'cholesterol', 'vitamin', 'mineral',
            
            // Special Populations
            'pregnancy', 'child', 'baby', 'infant', 'elderly', 'senior', 'adult', 'pediatric',
            'maternal', 'prenatal', 'postnatal', 'menstrual', 'menopause', 'hormone', 'thyroid',
            
            // Emergency Terms
            'emergency', 'urgent', 'acute', 'severe', 'critical', 'life-threatening', 'dangerous',
            'poison', 'overdose', 'allergic', 'reaction', 'shock', 'bleeding', 'unconscious',
            
            // Common Health Questions
            'what should i do', 'how to treat', 'how to cure', 'how to prevent', 'what causes',
            'what are the symptoms', 'what are the signs', 'when to see a doctor', 'which doctor',
            'how long', 'how often', 'how much', 'how many', 'is it serious', 'is it dangerous',
            
            // Additional Patient Questions
            'can you help me', 'i need help', 'i have a problem', 'i am worried about',
            'what medicine should i take', 'which medicine is best', 'is there any medicine',
            'do i need surgery', 'is surgery required', 'what are the treatment options',
            'what are the side effects', 'is it contagious', 'can it spread',
            'how long will it take to recover', 'when will i feel better', 'will i get better',
            'what should i eat', 'what foods to avoid', 'diet recommendations',
            'can i exercise', 'should i rest', 'how much rest do i need',
            'is it normal', 'is this common', 'should i be worried',
            'what are the complications', 'what could happen', 'is it life threatening',
            'do i need tests', 'what tests are required', 'do i need blood test',
            'can it be cured', 'is there a cure', 'will it come back',
            'is it hereditary', 'runs in family', 'genetic condition',
            'home remedies', 'natural treatment', 'alternative medicine',
            'emergency symptoms', 'warning signs', 'red flags',
            'second opinion', 'specialist doctor', 'expert consultation',
            'vaccination needed', 'preventive measures', 'how to protect',
            'recovery time', 'healing period', 'when can i resume work',
            'follow up needed', 'next appointment', 'regular checkup',
            'medical history', 'previous conditions', 'related problems',
            'age related', 'common in children', 'affects elderly',
            'lifestyle changes', 'habits to change', 'what to avoid',
            'prescription needed', 'over the counter', 'pharmacy medicine',
            'cost of treatment', 'insurance coverage', 'medical expenses',
            'new symptoms', 'getting worse', 'not improving',
            'seasonal problem', 'weather effects', 'environmental factors',
            'mental health', 'emotional support', 'counseling needed',
            'pregnancy safe', 'breastfeeding safe', 'child safe',
            'emergency care', 'urgent care', 'hospital visit',
            'chronic condition', 'long term effects', 'permanent damage',
            'disability', 'work limitation', 'daily activities',
            'pain management', 'pain relief', 'reduce pain',
            'medical procedure', 'operation details', 'surgical options',
            'rehabilitation', 'physical therapy', 'occupational therapy',
            'alternative treatment', 'complementary medicine', 'holistic approach',
            'medical equipment', 'devices needed', 'mobility aids',
            'support groups', 'patient communities', 'care services',
            'clinical trials', 'new treatments', 'research studies',
            'medical records', 'health documents', 'test reports',
            'travel restrictions', 'activity limitations', 'lifestyle impact',
            'family planning', 'fertility issues', 'reproductive health',
            'dental care', 'oral health', 'teeth problems',
            'eye care', 'vision problems', 'optical issues',
            'hearing problems', 'ear issues', 'auditory concerns',
            'skin care', 'dermatological issues', 'cosmetic concerns',
            'weight management', 'obesity issues', 'diet control',
            'vaccination schedule', 'immunization records', 'booster shots',
            'medical cannabis', 'alternative therapy', 'pain medication',
            'organ donation', 'transplant options', 'medical procedures',
            'blood tests', 'diagnostic tests', 'screening tests',
            'medical history', 'family history', 'genetic testing',
            'medical emergency', 'urgent care', 'immediate attention',
            'specialist referral', 'doctor recommendation', 'medical opinion',
            'treatment plan', 'care protocol', 'medical regimen',
            'recovery timeline', 'healing process', 'rehabilitation period',
            'medical costs', 'insurance coverage', 'payment options',
            'side effects', 'adverse reactions', 'complications',
            'medical certificates', 'health documents', 'medical reports',
            'travel clearance', 'fit to fly', 'medical restrictions',
            'work restrictions', 'medical leave', 'sick note',
            'follow up care', 'post treatment', 'ongoing care',
            'preventive care', 'health screening', 'regular checkups',
            'lifestyle modifications', 'behavioral changes', 'habit changes',
            'medical equipment', 'assistive devices', 'mobility aids',
            'home care', 'nursing care', 'palliative care',
            'emergency contacts', 'medical helpline', 'healthcare support',
            'medical research', 'clinical studies', 'treatment advances',
            'alternative medicine', 'complementary therapy', 'natural remedies',
            'medical tourism', 'overseas treatment', 'healthcare abroad',
            'telemedicine', 'online consultation', 'virtual doctor',
            'medical insurance', 'health coverage', 'medical benefits',
            'medical transportation', 'ambulance service', 'patient transfer',
            'organ transplant', 'tissue donation', 'medical procedures',
            'blood donation', 'plasma therapy', 'transfusion services',
            'vaccination records', 'immunization history', 'medical records',
            'medical education', 'health awareness', 'patient information',
            'medical compliance', 'treatment adherence', 'medication schedule',
            'medical devices', 'health gadgets', 'monitoring equipment',
            'medical supplies', 'healthcare products', 'medical accessories',
            'medical waste', 'biohazard disposal', 'healthcare safety',
            'medical ethics', 'patient rights', 'healthcare laws',
            'medical privacy', 'health data', 'confidentiality',
            'medical research', 'clinical trials', 'experimental treatment',
            'medical tourism', 'healthcare abroad', 'international treatment',
            'telemedicine', 'remote healthcare', 'virtual consultation',
            'medical insurance', 'healthcare coverage', 'medical benefits',
            'medical transportation', 'patient transfer', 'ambulance services'
        ];

        // Check if message contains any health-related keywords
        const hasHealthKeyword = healthKeywords.some(keyword => messageLower.includes(keyword));
        ...
        const hasHealthQuestionPattern = healthQuestionPatterns.some(pattern => pattern.test(messageLower));
    ...
    const formatMessageContent = (content) => {
        ...
        const doctorSpecialties = [
            'General Physician', 'Pediatrician', 'Cardiologist', 'Neurologist', 'Dermatologist',
            'Orthopedist', 'Gynecologist', 'Psychiatrist', 'ENT Specialist', 'Ophthalmologist',
            'Dentist', 'Endodontist', 'Periodontist', 'Oral Surgeon', 'Endocrinologist',
            'Gastroenterologist', 'Pulmonologist', 'Rheumatologist', 'Oncologist', 'Urologist',
            'Allergist', 'Emergency Department', 'Infectious Disease Specialist', 'Physiotherapist',
            'Maxillofacial Surgeon', 'TMJ Specialist', 'Pediatric Dentist', 'Orthodontist'
        ];
    ...
    const generateBotResponse = async (message) => {
        ...
        if (!isHealthRelated(message)) {
            const response = "I'm a healthcare assistant and can only help with health-related questions. Please ask about medical conditions, symptoms, treatments, or general health advice. For non-health questions, please consult other appropriate resources.";
